...
public class UserAgent extends Agent{
	...
	private UserJFrame userJFrame;
	private ConfigurePredictionJFrame configurePredictionJFrame;
	...
	public UserAgent(){
		...
		this.canTrain = false;
		this.userJFrame = new UserJFrame(this);
		this.configurePredictionJFrame = new ConfigurePredictionJFrame(this);
	...
	protected void setup() {
		...
		this.getUserJFrame().setVisible(true);
	}
	...
	public UserJFrame getUserJFrame() {
		return userJFrame;
	}

	public void setUserJFrame(UserJFrame userJFrame) {
		this.userJFrame = userJFrame;
	}

	public ConfigurePredictionJFrame getConfigurePredictionJFrame() {
		return configurePredictionJFrame;
	}

	public void setConfigurePredictionJFrame(ConfigurePredictionJFrame configurePredictionJFrame) {
		this.configurePredictionJFrame = configurePredictionJFrame;
	}
