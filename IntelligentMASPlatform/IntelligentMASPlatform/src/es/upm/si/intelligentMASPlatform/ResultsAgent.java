...
public class ResultsAgent extends Agent{
	...
	private ResultsJFrame resultsJFrame;
	...
	public ResultsAgent(){
		super();
		this.resultsJFrame = new ResultsJFrame(this);
	...
	public ResultsJFrame getResultsJFrame() {
		return resultsJFrame;
	}

	public void setResultsJFrame(ResultsJFrame resultsJFrame) {
		this.resultsJFrame = resultsJFrame;
	}
